...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'apps-users': RouteRecordInfo<'apps-users', '/apps/users', Record<never, never>, Record<never, never>>,
    ...
    'catalogs-impuestos': RouteRecordInfo<'catalogs-impuestos', '/catalogs/impuestos', Record<never, never>, Record<never, never>>,
    'catalogs-lineas': RouteRecordInfo<'catalogs-lineas', '/catalogs/lineas', Record<never, never>, Record<never, never>>,
    'catalogs-order-type-assignment-schedules': RouteRecordInfo<'catalogs-order-type-assignment-schedules', '/catalogs/order-type-assignment-schedules', Record<never, never>, Record<never, never>>,
    'catalogs-order-type-assignments': RouteRecordInfo<'catalogs-order-type-assignments', '/catalogs/order-type-assignments', Record<never, never>, Record<never, never>>,
    'catalogs-order-type-schedules': RouteRecordInfo<'catalogs-order-type-schedules', '/catalogs/order-type-schedules', Record<never, never>, Record<never, never>>,
    'catalogs-order-types': RouteRecordInfo<'catalogs-order-types', '/catalogs/order-types', Record<never, never>, Record<never, never>>,
    'catalogs-productos': RouteRecordInfo<'catalogs-productos', '/catalogs/productos', Record<never, never>, Record<never, never>>,
    'catalogs-series-sucursal': RouteRecordInfo<'catalogs-series-sucursal', '/catalogs/series-sucursal', Record<never, never>, Record<never, never>>,
    'catalogs-tipos-serie': RouteRecordInfo<'catalogs-tipos-serie', '/catalogs/tipos-serie', Record<never, never>, Record<never, never>>,
    'catalogs-unidades': RouteRecordInfo<'catalogs-unidades', '/catalogs/unidades', Record<never, never>, Record<never, never>>,
    ...
    'remisiones-recepcion': RouteRecordInfo<'remisiones-recepcion', '/remisiones/recepcion', Record<never, never>, Record<never, never>>,
    'remisiones-recepcion-id': RouteRecordInfo<'remisiones-recepcion-id', '/remisiones/recepcion/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'remisiones-remisiones-erp': RouteRecordInfo<'remisiones-remisiones-erp', '/remisiones/remisiones-erp', Record<never, never>, Record<never, never>>,
    'remisiones-remisiones-erp-id': RouteRecordInfo<'remisiones-remisiones-erp-id', '/remisiones/remisiones-erp/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
